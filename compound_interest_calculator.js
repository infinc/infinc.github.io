  ...
  function calculateInterest() {
    ...
    resultTable.innerHTML = `
      <table class="min-w-full divide-y divide-gray-300 dark:divide-gray-700">
        <tbody>
          <tr>
            <td class="px-4 text-gray-500 dark:text-gray-400 text-left text-sm">Principal Amount:</td>
          </tr>
          <tr>
            <td class="px-4 text-left">₹ ${principal.toLocaleString('en-IN')}</td>
          </tr>
          <tr>
            <td class="px-4 text-gray-500 dark:text-gray-400 text-left text-sm">Annual Interest Rate:</td>
          </tr>
          <tr>
            <td class="px-4 text-left">${rate} %</td>
          </tr>
          <tr>
            <td class="px-4 text-gray-500 dark:text-gray-400 text-left text-sm">Time:</td>
          </tr>
          <tr>
            <td class="px-4 text-left">${time} years</td>
          </tr>
          <tr>
            <td class="px-4 text-gray-500 dark:text-gray-400 text-left text-sm">Compounds per Year:</td>
          </tr>
          <tr>
            <td class="px-4 text-left">${compounds}</td>
          </tr>
          <tr>
            <td class="px-4 text-gray-500 dark:text-gray-400 text-left text-sm">Compound Interest:</td>
          </tr>
          <tr>
            <td class="px-4 text-left">${formattedInterest}</td>
          </tr>
          <tr>
            <td class="px-4 text-gray-500 dark:text-gray-400 text-left text-sm">Total Amount:</td>
          </tr>
          <tr>
